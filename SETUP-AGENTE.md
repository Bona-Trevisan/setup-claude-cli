...
```bash
ssh_run "curl -fsSL https://raw.githubusercontent.com/Bona-Trevisan/setup-claude-cli/main/bootstrap.sh | bash"
```
...
https://github.com/{{GITHUB_USERNAME}}/setup-claude-cli/issues
